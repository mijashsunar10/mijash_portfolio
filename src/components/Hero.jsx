  ...
  <div className="scene-inner">
    ...
    <div className="hero-content">
      ...
      <p className="hero-desc">
        Technology professional and digital strategist with 5+ years building 
        scalable web solutions, driving digital growth, and mentoring future 
        IT professionals from Pokhara, Nepal.
      </p>
      <div className="hero-actions">
        <button className="btn-primary" onClick={onContact}>
          <Mail size={14} /> Contact Me
        </button>
        <a className="btn-ghost" href="tel:+9779826115361">
